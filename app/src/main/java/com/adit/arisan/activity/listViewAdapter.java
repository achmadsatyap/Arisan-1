...
class listViewAdapter extends BaseAdapter {
    ...
    public listViewAdapter(Context context, ArrayList<Model> modelArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.nama.setText(modelArrayList.get(position).getAnimal());
